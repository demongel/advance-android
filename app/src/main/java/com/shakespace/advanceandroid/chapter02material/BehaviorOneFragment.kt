...
import kotlinx.android.synthetic.main.fragment_behavior_one.*
import kotlinx.android.synthetic.main.fragment_coordinator.toolbar

/**
 * A simple [Fragment] subclass.
 */
class BehaviorOneFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_behavior_one, container, false)
    }
